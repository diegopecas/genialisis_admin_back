...
Flight::route('GET /reportes-pago/cliente/@id', [ReportesPago::class, 'getByCliente']);
...
Flight::route('GET /reportes-pago/pendientes-cliente/@id', [ReportesPago::class, 'getPendientesByCliente']);
